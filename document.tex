...
\documentclass[accentcolor=tud9c,11pt,nochapname,bigchapter]{tudreport}
...
\subsubtitle{Autor: Daniel Thiem - studium@daniel-thiem.de\\Version 0.5 - 20.09.2012}
...
\begin{equation}
X_{RMS}=\sqrt{\lim_{M \rightarrow \infty} \frac{1}{2M+1} \sum\limits_{n=-M}^M X(n)^2}=\sqrt{r_{XX}(0)}=\sqrt{\int\limits_{-\pi}^\pi S_{XX}(e^{j\omega}) \frac{d\omega}{2\pi} }
\end{equation}
